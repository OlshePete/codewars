...
import { ViewerProvider } from '../../../context/useViewerPayloadContext';
import { IFile } from '@skif/utils';
import { getExecutors } from '../../kanban/utils/usersUtils';
...
const useTaskPanelContext = () => {
  ...
  if (context === undefined) {
    throw new Error('useTaskPanelContext22 must be used within a TaskPanelProvider');
  }

...
import { createAuthor } from '../../../../../../utils/usersUtils';
import { usePanelDataContext } from '../../../../../context/usePanelDataContext';
import { checkIsSubtasksDone, checkSelfAsAuthor, checkSelfAsCoExecutor, checkSelfAsExecutor, getMembersWithoutObserves, getObservers } from '../../../../utils/usersUtils';
import { TViewTask, TasksStatus } from '../../../../../types/tasksInterfaces';
import { isProcessSubtask } from '../../../../utils/isProcessSubtask';
import { getMembersList, updateConfMembers } from '../../../TaskPanelContent/components/CommentsTab/utils/conferenceUtils';
...
const Footer: React.FC<Partial<IFooter>> = ({ isEdit = false, className, setEdit, ...props }) => {
  ...
  const { conferences, setDeferMessage, } = usePanelCommentsContext()
...
useEffect(() => {
  console.log(`\x1b[36m task \x1b[0m`,`: `,task)
}, [task])
